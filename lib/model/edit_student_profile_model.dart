class EditStudentProfile {
  ...
  EditStudentProfile.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    content =
...
class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    phone = json['phone'];
    image = json['image'];
    currentTeamId = json['currentTeamId']!=null?json['currentTeamId']:"";
    profilePhotoPath = json['profilePhotoPath']!=null?json['profilePhotoPath']:"";
