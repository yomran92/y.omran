...
password2Controller.text=currentPassword;
 ...
 return Scaffold(
      ...
      body:professourProfileResponseModel.content!=null? 
      Container(
        child:
      Stack(
        children: <Widget>[
...
//         );
   ...
   else
   {
    ...
    return Scaffold(
      resizeToAvoidBottomInset: true,
      backgroundColor: const Color(0xffffffff),
      body:studentProfileResponseModel.content!=null? 
      Container(
        child:
      Stack(
        children: <Widget>[
...
Future <EditStudentProfile>editStudentProfileApiResponse(){
 ...
 password2Controller.text,studentProfileResponseModel.content.user.egyptian.toString(),
